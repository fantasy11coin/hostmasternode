...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in betfint.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("betfint.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Betfint features */
    { "betfint",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "betfint",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "betfint",               "gobject",                &gobject,                true,  {} },
    { "betfint",               "voteraw",                &voteraw,                true,  {} },
