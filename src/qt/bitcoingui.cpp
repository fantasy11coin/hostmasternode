...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Fantasy11 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fantasy11: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about Fantasy11 Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Fantasy11 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Fantasy11 addresses"));
    ...
    openAction->setStatusTip(tr("Open a fantasy11: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Fantasy11 command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Fantasy11 network", "", count));
    } else {
...
{
    QString strTitle = tr("Fantasy11 Core"); // default title
    ...
    // Append title to "Fantasy11 Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
