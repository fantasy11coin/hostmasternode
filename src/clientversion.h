...
//! These need to be macros, as clientversion.cpp's and betfint*-res.rc's voodoo requires it
...
/**
 * betfintd-res.rc includes this file, but it cannot cope with real c++ code.
