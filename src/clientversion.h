...
//! These need to be macros, as clientversion.cpp's and fantasy11*-res.rc's voodoo requires it
...
/**
 * fantasy11d-res.rc includes this file, but it cannot cope with real c++ code.
