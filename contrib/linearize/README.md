# Linearize
Construct a linear, no-fork, best version of the Betfint blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install betfint_hash

https://github.com/betfintpay/betfint_hash
...
JSON-RPC server. Running `betfintd` or `betfint-qt -server` will be sufficient.
...
* `input`: betfintd blocks/ directory containing blkNNNNN.dat
