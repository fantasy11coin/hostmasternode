# Linearize
Construct a linear, no-fork, best version of the Fantasy11 blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install fantasy11_hash

https://github.com/fantasy11pay/fantasy11_hash
...
JSON-RPC server. Running `fantasy11d` or `fantasy11-qt -server` will be sufficient.
...
* `input`: fantasy11d blocks/ directory containing blkNNNNN.dat
