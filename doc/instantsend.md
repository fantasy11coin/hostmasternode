...
This mechanism has been integrated into Bitcore-Node-Betfint which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/betfintpay/insight-api-betfint#web-socket-api](https://github.com/betfintpay/insight-api-betfint#web-socket-api)
* API: [https://github.com/betfintpay/insight-api-betfint#instantsend-transactions](https://github.com/betfintpay/insight-api-betfint#instantsend-transactions)
...
By default, the Betfint Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Betfint Core daemon:
