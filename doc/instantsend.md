...
This mechanism has been integrated into Bitcore-Node-Fantasy11 which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/fantasy11pay/insight-api-fantasy11#web-socket-api](https://github.com/fantasy11pay/insight-api-fantasy11#web-socket-api)
* API: [https://github.com/fantasy11pay/insight-api-fantasy11#instantsend-transactions](https://github.com/fantasy11pay/insight-api-fantasy11#instantsend-transactions)
...
By default, the Fantasy11 Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Fantasy11 Core daemon:
