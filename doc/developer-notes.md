...
Fantasy11 Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Fantasy11 Core, where everyone uses
...
pay attention to for reviewers of Fantasy11 Core code.

General Fantasy11 Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Fantasy11 Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Fantasy11 Core so that they can be integrated
