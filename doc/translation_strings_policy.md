...
This document provides guidelines for internationalization of the Betfint Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `betfint_en.ts` remains unchanged.
